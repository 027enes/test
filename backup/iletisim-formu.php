...
<cms:template title='İletişim Formu' hidden='1' order='100' />
...
<div id="icerik">
    ...
    <div class="icerik">
        <h1 class="baslik">İLETİŞİM FORMU</h1>
        <div class="yazi">
        ...
        <p>Gönderen :'.$ad.'</p><p>Soyadı :'.$soyad.'</p><p> Telefon: '.$telefon.'</p><p> E-mail :  '.$email.'</p><p> Mesaj :  '.$mesaj.'</p></div>';
