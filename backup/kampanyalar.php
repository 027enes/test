...
<cms:template title='Kampanyalar' clonable='1' order='4' >
<cms:editable  name='kur' label='Kampanyalar İçerik' desc='Kampanyalar Sayfası İçerik' type='group' order='1' />
<cms:editable group='kur' type='richtext' toolbar='custom' custom_toolbar="<cms:embed 'my_toolbar.inc' />"  name='icerik' label='Kampanyalar İçerik' />
<cms:editable group='kur' name='folder_weights' validator='decimal' search_type='decimal' type='text' label='Kampanyalar Sıralaması' />
...
<!-- BANNER -->
<div id="banner" style="background: url(<cms:pages masterpage='ayarlar.php'><cms:show urunler /></cms:pages>) no-repeat center center; background-size:cover;"><h1>Kampanyalar</h1></div>
<!-- ## BANNER -->
