<?php
    ...
    define( 'K_DB_NAME', 'horizontarim' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'horizontarim' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'Pb3x85e?' );
    // 7.
    ...
    define( 'K_PAID_LICENSE', 1 );
        ...
        define( 'K_ADMIN_FOOTER', '<a href="http://www.fagusmedia.com">Fagusmedia Content Managment System</a>' );